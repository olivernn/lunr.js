...
/**
 * Search.Deferred is an implementation of a deferred object and is used throughout the Search library for
 * dealing with asynchronous calls and requests.  A deferred object can either be stand-alone or wrap other
 * instances of Search.Defered objects.
 *
...
Search.Deferred.prototype = {
  /**
   * ## Search.Deferred.prototype.resolve
  ...
  /**
   * ## Search.Deferred.prototype.fail
  ...
  /**
   * ## Search.Deferred.prototype.then
   ...
   * @returns {Search.Deferred} returns this instance to allow for chaining.
   *
   * ### Example
   *     deferred.then(function () { console.log('success') })
   */
  ...
  /**
   * ## Search.Deferred.prototype.thenLog
