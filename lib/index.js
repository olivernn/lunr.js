 ...
 * AND based query by default, e.g. `idx.search('foo bar')` will run a search for
 * documents containing both 'foo' and 'bar'.
 * 
 * You can change the default AND based query by passing lunr.query.OR to the optional `type`
 * paramter. e.g. `idx.search('foo bar',lunr.query.OR)` will run a search for
 * documents containing words either 'foo' or 'bar' or both. 
 *
 ...
 * @param {String} type  Use OR based query instead AND based query
 * @returns {Object}
 * @see Index.prototype.idf
 * @see Index.prototype.documentVector
 * @memberOf Index
 */
lunr.Index.prototype.search = function (query,type) {
