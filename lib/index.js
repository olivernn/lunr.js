...
lunr.Index.prototype.query = function (fn) {
  ...
  for (var i = 0; i < query.clauses.length; i++) {
     ...
     * of processed terms. Pipeline functions may exand the passed
...
lunr.Index.load = function (serializedIndex) {
  ...
  if (serializedIndex.version != lunr.version) {
    lunr.utils.warn("Version mismatch when loading serialised index. Current version of lunr '" + lunr.version + "' does not match serailzed index '" + serializedIndex.version + "'")
  }
